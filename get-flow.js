...
async function processReport() {
  try {
    var marker;
    try {
      var markerFile = fs.readFileSync("/Users/ayman.naji/flow-markers", "UTF-8");
    ...
    const data = fs.readFileSync("/Users/ayman.naji/flow/flow-data", "UTF-8");
    ...
    fs.writeFile(
      "/Users/ayman.naji/flow/flow-markers",
      ...
      for (j = 0; j < objects.Contents.length; j++) {
        ...
        if (objects.Contents[j].LastModified.getTime() > compareTime) {
          ...
          for (k = 0; k < logEntry.number_of_flow_logs; k++) {
            ...
            let jsonContent = JSON.stringify(esObject);
